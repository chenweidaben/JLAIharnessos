# medical_record_front_page_check — 病案首页质控

> 所属分类：**质控管理** ｜ 工具名：`medical_record_front_page_check` ｜ 风险等级：**LOW**（低（只读/查询类））

## 工具描述

对出院病案首页进行逻辑校验，检测主要诊断/手术/费用一致性问题。
...
{
  "success": true,
  "data": { "tool": "medical_record_front_page_check", "status": "ok" }
}
```
