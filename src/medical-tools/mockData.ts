...
// ============================================================================
// 相对日期工具复用（与 patientServiceData 同一实现，避免 time-bomb 硬编码）
// ----------------------------------------------------------------------------
// 凡与"今天/距今N天/是否过期/是否今日"相关的业务日期（就诊、医嘱、检验、
// 影像、病历、处方开立/审核、生命体征测量时间等）一律通过 mockDate/mockDateTime
// 相对当前日期动态生成，禁止硬编码绝对日期；患者出生日期、病史诊断日、
// 过敏记录日、知识库/模板版本日等本就应固定的历史/法定日期保持字面量。
// ============================================================================

import { mockDate, mockDateTime } from './patient-service/patientServiceData.js';
...
export const MOCK_PATIENTS: MockPatient[] = [
  {
    ...
    latestVitals: {
      ...
      spo2: 97,
      measuredAt: mockDateTime(-7, 8, 30),
    },
  },
  {
    ...
    latestVitals: {
      ...
      spo2: 93,
      measuredAt: mockDateTime(-6, 10, 15),
    },
  },
  {
    ...
    latestVitals: {
      ...
      spo2: 98,
      measuredAt: mockDateTime(-8, 14, 20),
    },
  },
  {
  ...
  },
  {
    ...
    latestVitals: {
      ...
      spo2: 95,
      measuredAt: mockDateTime(-5, 7, 45),
    },
  },
  {
    ...
    latestVitals: {
      ...
      spo2: 99,
      measuredAt: mockDateTime(-11, 10, 30),
    },
  },
];
...
处理建议：1.建议住院行冠脉造影检查；2.阿司匹林100mg qd + 氯吡格雷75mg qd双联抗血小板；3.阿托伐他汀20mg qn；4.美托洛尔47.5mg qd；5.硝酸甘油片必要时含服；6.监测血压、血糖。`,
    status: '已确认',
    createdAt: mockDateTime(-7, 9, 30),
    createdBy: '王主任',
    confirmedAt: mockDateTime(-7, 10, 15),
    confirmedBy: '王主任',
    qcScore: 92,
  },
  {
...
诊疗计划：1.心内科护理常规，一级护理，低盐低脂糖尿病饮食；2.完善血常规、生化、凝血、心肌酶谱等检查；3.阿司匹林+氯吡格雷双联抗血小板，低分子肝素抗凝，阿托伐他汀调脂，美托洛尔控制心率；4.择期行冠脉造影+PCI术。`,
    status: '已归档',
    createdAt: mockDateTime(-18, 15, 0),
    createdBy: '李住院医',
    confirmedAt: mockDateTime(-18, 17, 30),
    confirmedBy: '王主任',
    qcScore: 88,
  },
  {
...
诊疗计划：1.呼吸内科护理常规，二级护理，低盐饮食；2.头孢曲松2g qd静滴抗感染，氨溴索30mg bid静滴化痰；3.低流量吸氧，沙丁胺醇雾化吸入平喘；4.完善血气分析、痰培养、降钙素原等检查。`,
    status: '已确认',
    createdAt: mockDateTime(-9, 11, 0),
    createdBy: '吴住院医',
    confirmedAt: mockDateTime(-9, 14, 0),
    confirmedBy: '陈医生',
    qcScore: 85,
  },
  {
...
处理：1.发病2小时，在静脉溶栓时间窗内，评估无溶栓禁忌，予阿替普酶静脉溶栓治疗；2.收入神经内科重症监护室；3.完善头颅MRI+MRA、凝血功能、血糖等检查；4.监测生命体征及神经功能变化。`,
    status: '已确认',
    createdAt: mockDateTime(-5, 8, 15),
    createdBy: '急诊张医生',
    confirmedAt: mockDateTime(-5, 9, 0),
    confirmedBy: '周主任',
    qcScore: 90,
  },
];
...
export const MOCK_LAB_REPORTS: MockLabReport[] = [
  {
    ...
    testCategory: '血常规',
    specimen: '静脉血（EDTA抗凝）',
    collectedAt: mockDateTime(-7, 8, 0),
    reportedAt: mockDateTime(-7, 8, 45),
  ...
  },
  {
    ...
    specimen: '静脉血（分离胶）',
    collectedAt: mockDateTime(-7, 8, 0),
    reportedAt: mockDateTime(-7, 9, 30),
    reportingDoctor: '检验师-林',
    status: '已审核',
    hasCriticalValue: false,
    items: [
  ...
  },
  {
    ...
    testCategory: '生化',
    specimen: '静脉血（促凝管）',
    collectedAt: mockDateTime(-7, 8, 5),
    reportedAt: mockDateTime(-7, 8, 50),
    reportingDoctor: '检验师-林',
    status: '已审核',
    hasCriticalValue: false,
    items: [
  ...
  },
  {
    ...
    testCategory: '血常规',
    specimen: '静脉血（EDTA抗凝）',
    collectedAt: mockDateTime(-9, 10, 30),
    reportedAt: mockDateTime(-9, 11, 15),
  ...
  },
  {
    ...
    testCategory: '生化',
    specimen: '静脉血',
    collectedAt: mockDateTime(-5, 7, 50),
    reportedAt: mockDateTime(-5, 8, 20),
    reportingDoctor: '检验师-黄',
    status: '已审核',
